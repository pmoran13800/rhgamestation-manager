...
from .views.config import RHGamestationConfigFormView
...
from .views.moonlight import RHGamestationMoonlightFormView
...
urlpatterns = [
    ...
    url(r'^config/$', RHGamestationConfigFormView.as_view(), name='config'),
    ...
    url(r'^moonlight/$', RHGamestationMoonlightFormView.as_view(), name='moonlight'),

...
class BiosListView(MultiFormView):
    """
    List supported Bios from RHGamestation manifest
    ...
    def get_existing_bios_list(self):
        ...
        """
        path = settings.RHGAMESTATION_BIOS_PATH
    ...
    def get_bios_manifest(self):
        ...
        for system_key, system_datas in RHGAMESTATION_MANIFEST.items():
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            'bios_path': settings.RHGAMESTATION_BIOS_PATH,

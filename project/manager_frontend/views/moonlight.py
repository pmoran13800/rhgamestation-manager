...
class RHGamestationMoonlightFormView(FormView):
    """
    Display a form to edit the RHGamestation config file
    """
    template_name = "manager_frontend/config_form.html"
    form_class = ConfigEditForm

    def dispatch(self, request, *args, **kwargs):
        self.config_filepath = settings.RHGAMESTATION_MOONLIGHT_PATH
        self.config_content = self.get_config_file(self.config_filepath)
        
        self.backup_filepath = settings.RHGAMESTATION_MOONLIGHT_BACKUP_PATH
        ...
        return super(RHGamestationMoonlightFormView, self).dispatch(request, *args, **kwargs)
    ...
    def get_context_data(self, **kwargs):
        context = super(RHGamestationMoonlightFormView, self).get_context_data(**kwargs)
        context.update({
    ...
    def get_success_url(self):
        return reverse('manager:moonlight')
            
    def get_form_kwargs(self):
        context = super(RHGamestationMoonlightFormView, self).get_form_kwargs()
        context.update({
            'config_filepath': self.config_filepath,
            'backup_filepath': self.backup_filepath,
        })
    ...
    def form_valid(self, form):
        ...
        return super(RHGamestationMoonlightFormView, self).form_valid(form)

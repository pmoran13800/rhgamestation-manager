...
class RHGamestationConfigFormView(FormView):
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        self.config_filepath = settings.RHGAMESTATION_CONF_PATH
        self.config_content = self.get_config_file(self.config_filepath)
        
        self.backup_filepath = settings.RHGAMESTATION_CONF_BACKUP_PATH
        ...
        return super(RHGamestationConfigFormView, self).dispatch(request, *args, **kwargs)
    ...
    def get_context_data(self, **kwargs):
        context = super(RHGamestationConfigFormView, self).get_context_data(**kwargs)
        context.update({
    ...
    def get_form_kwargs(self):
        context = super(RHGamestationConfigFormView, self).get_form_kwargs()
        context.update({
            'config_filepath': self.config_filepath,
            'backup_filepath': self.backup_filepath,
        })
    ...
    def form_valid(self, form):
        ...
        return super(RHGamestationConfigFormView, self).form_valid(form)

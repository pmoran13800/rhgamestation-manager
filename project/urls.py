"""rhgamestation-manager URL Configuration
...
# Load RHGamestation manifest in memory
from project import rhgamestation_manifest
rhgamestation_manifest.autodiscover()
